...
//         console.log (num);                                   //выводить num   
//         num++;                                               //увеличивать num на единицу. а если юзать <= то мы увидим и 55 в логе.    
// } 

do {
        console.log (num);                                      //данная конструкция сначало делает, а только потом проверяет условия
        num++;
}
while ()